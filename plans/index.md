...
- **003-date-grouped-markdown.md** — H1 becomes the run timestamp; memos are grouped under per-date H2 sections with H3 memo headings; non-parseable memos fall under a trailing `## Unknown date`.
